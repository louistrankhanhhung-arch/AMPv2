...
DEFAULT_UNIVERSE = [
    ...
    "MANA/USDT","MOVE/USDT","NEAR/USDT","OP/USDT", "ORDI/USDT","PENDLE/USDT","QNT/USDT","RENDER/USDT","ROSE/USDT",
    "RUNE/USDT","SAND/USDT","SEI/USDT","SNX/USDT","SOL/USDT","SUI/USDT","TAO/USDT","TIA/USDT","TON/USDT",
    "TRX/USDT","UNI/USDT","VET/USDT","WLFI/USDT","XLM/USDT","XRP/USDT",
]
