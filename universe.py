...
DEFAULT_UNIVERSE = [
    ...
    "LTC/USDT","MOVE/USDT","NEAR/USDT","OP/USDT", "ORDI/USDT","PENDLE/USDT","QNT/USDT","SAND/USDT","SEI/USDT",
    "SOL/USDT","SUI/USDT","TAO/USDT","TIA/USDT","TON/USDT","TRX/USDT","UNI/USDT","XLM/USDT","XRP/USDT",
]
